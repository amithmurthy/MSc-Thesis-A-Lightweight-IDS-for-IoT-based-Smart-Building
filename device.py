...
class DeviceProfile:
        ...
        def identify_attack_flows(self, DeviceAttacks, date):
            ...
            relevant_metadata = {k: DeviceAttacks.attack_metadata[k] for k in list(DeviceAttacks.relative_attack_timestamp[date])}

            def get_pkt_time(flow, position):
                return flow_table[flow][position]['relative_timestamp']

            def get_attack_protocol(attack_window):
